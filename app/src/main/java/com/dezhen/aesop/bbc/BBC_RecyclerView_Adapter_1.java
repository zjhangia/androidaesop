...
public class BBC_RecyclerView_Adapter_1 extends RecyclerView.Adapter<BBC_RecyclerView_Adapter_1.BBCViewHolder> {

    private static Context context;
    private ArrayList<BBC_Card> arrayList;

    public BBC_RecyclerView_Adapter_1(Context context, ArrayList<BBC_Card> arrayList) {
    ...
    @NotNull
    @Override
    public BBC_RecyclerView_Adapter_1.BBCViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull BBC_RecyclerView_Adapter_1.BBCViewHolder holder, int position) {
    ...
    public static class BBCViewHolder extends RecyclerView.ViewHolder{
        ...
        public BBCViewHolder(@NonNull @NotNull View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                //create intent
                Intent intent = new Intent(context, BBC_Content_1.class);
                Bundle bundle = new Bundle();
                final String TAG = "BBC_Content_1";
                switch(position) {
                    case 0:
