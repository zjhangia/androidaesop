...
public class BBC_RecyclerView_Adapter_3 extends RecyclerView.Adapter<BBC_RecyclerView_Adapter_3.BBCViewHolder> {

    private  static Context context;
    private ArrayList<BBC_Card> arrayList;

    public BBC_RecyclerView_Adapter_3(Context context, ArrayList<BBC_Card> arrayList) {
    ...
    @NotNull
    @Override
    public BBC_RecyclerView_Adapter_3.BBCViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull BBC_RecyclerView_Adapter_3.BBCViewHolder holder, int position) {
        ...
        public BBCViewHolder(@NonNull @NotNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    //create intent
                    Intent intent = new Intent(context, BBC_Content_3.class);
                    Bundle bundle = new Bundle();
                    final String TAG = "BBC_Content_3";
                    switch(position) {
                        case 0:
