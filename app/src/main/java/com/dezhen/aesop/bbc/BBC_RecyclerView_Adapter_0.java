...
public class BBC_RecyclerView_Adapter_0 extends RecyclerView.Adapter<BBC_RecyclerView_Adapter_0.BBCViewHolder> {

    private  static Context context;
    private ArrayList<BBC_Card> arrayList;

    public BBC_RecyclerView_Adapter_0(Context context, ArrayList<BBC_Card> arrayList) {
    ...
    @NotNull
    @Override
    public BBC_RecyclerView_Adapter_0.BBCViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull BBC_RecyclerView_Adapter_0.BBCViewHolder holder, int position) {
    ...
    public static class BBCViewHolder extends RecyclerView.ViewHolder{
        ...
        public BBCViewHolder(@NonNull @NotNull View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                //create intent
                Intent intent = new Intent(context, BBC_Content_0.class);
                Bundle bundle = new Bundle();
                final String TAG = "BBC_Content_0";
                switch(position) {
                    case 0:
