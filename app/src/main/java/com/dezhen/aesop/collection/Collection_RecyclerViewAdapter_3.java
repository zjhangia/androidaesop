...
public class Collection_RecyclerViewAdapter_3 extends RecyclerView.Adapter<Collection_RecyclerViewAdapter_3.CollectionViewHolder>{
    private static Context context;
    private ArrayList<Collection_Card> arrayList;

    public Collection_RecyclerViewAdapter_3(Context context, ArrayList<Collection_Card> arrayList) {
    ...
    @NonNull
    @Override
    public Collection_RecyclerViewAdapter_3.CollectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        public CollectionViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, Co_Content_3.class);
                    Bundle bundle = new Bundle();
                    final String TAG = "Co_Content_3";
                    switch(position){
                        case 0:
