...
public class Collection_RecyclerViewAdapter_1 extends RecyclerView.Adapter<Collection_RecyclerViewAdapter_1.CollectionViewHolder>{
    private static Context context;
    private ArrayList<Collection_Card> arrayList;

    public Collection_RecyclerViewAdapter_1(Context context, ArrayList<Collection_Card> arrayList) {
    ...
    @NonNull
    @Override
    public Collection_RecyclerViewAdapter_1.CollectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        public CollectionViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, Co_Content_1.class);
                    Bundle bundle = new Bundle();
                    final String TAG = "Co_Content_1";
                    switch(position){
                        case 0:
