...
public class Collection_RecyclerViewAdapter_4 extends RecyclerView.Adapter<Collection_RecyclerViewAdapter_4.CollectionViewHolder>{
    private static Context context;
    private ArrayList<Collection_Card> arrayList;

    public Collection_RecyclerViewAdapter_4(Context context, ArrayList<Collection_Card> arrayList) {
    ...
    @NonNull
    @Override
    public Collection_RecyclerViewAdapter_4.CollectionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public static class CollectionViewHolder extends RecyclerView.ViewHolder{
        ...
        public CollectionViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                Intent intent = new Intent(context, Co_Content_4.class);
                Bundle bundle = new Bundle();
                final String TAG = "Co_Content_4";
                switch(position){
                    case 0:
